<template>
    <div>
      ...
      <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Sign in to your account Member</h2>
    ...
    <form class="mt-8 space-y-6" @submit="login">
        ...
        {{ errorMsg }}
          <span @click="errorMsg = '' " class="w-8 h-8">
      ...
      <div class="-space-y-px rounded-md shadow-sm">
        <div>
          ...
          <input id="email-address" name="email" type="email" v-model="user.email" autocomplete="email"  class="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Email address" />
        </div>
        <div>
